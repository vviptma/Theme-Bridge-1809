...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div class="title_outer title_without_animation" data-height="200">
        <div class="title title_size_small  position_left  has_fixed_background"
             style="background-size: 1584px;
             background-image: url('/wp-content/uploads/2019/03/BannerSlider-1-1.png');
             height: 200px;
             background-position: center 0px;">
            <div class="image not_responsive"></div>
            <div class="title_holder" style="padding-top: 100px;">
                <div class="container">
                    <div class="container_inner clearfix">
                        <div class="title_subtitle_holder">
                            <h1><span>Bài viết</span></h1>
                            <span class="subtitle" style="color:#ffffff">Chi tiết</span>
                        </div>
                    </div>
                </div>
            </div>
				...
				<?php endif; // post type end ?>
                    ...
                    <?php elseif($sidebar == "1" || $sidebar == "2"): ?>
						...
						<?php elseif($sidebar == "2") : ?>
							<div class="two_columns_75_25 background_color_sidebar grid2 clearfix custom-blog-post">
								<div class="column1">
						<?php endif; ?>
