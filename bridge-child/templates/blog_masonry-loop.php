...
$thumb_size = 'full';
//Number character show on title
$maxChars = 25;
if(!empty($thumb_size_temp)){
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="post_text">
                <div class="post_text_inner">
                    <h5 itemprop="name" class="entry_title"><a itemprop="url" href="<?php the_permalink(); ?>" target="_self" title="<?php the_title_attribute(); ?>">
                            <?php
                            $title = get_the_title();

                            if (strlen($title) > $maxChars) {
                                echo $title_excerpt = substr($title, 0, $maxChars) . '...';;
                            } else {
                                echo $title;
                            }
                            ?>
                ...
                <div class="post_text">
                    <div class="post_text_inner">
                        ...
                        <div class="post_title entry_title">
                            <p><a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                    <?php
                                    $title = get_the_title();
