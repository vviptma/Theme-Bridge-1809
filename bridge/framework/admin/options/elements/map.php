...
if(!function_exists('qode_elements_options_map')) {
    ...
    function qode_elements_options_map()
    {
		...
		$group_green = new QodeGroup("Green Button", 'Define styles for "Green" Button');
		$panel3->addChild("group_green", $group_green);
		$row1 = new QodeRow();
		$group_green->addChild("row1", $row1);
		$button_green_text_color = new QodeField("colorsimple", "button_green_text_color", "", "Text Color", "This is some description");
		$row1->addChild("button_green_text_color", $button_green_text_color);
		$button_green_text_color_hover = new QodeField("colorsimple", "button_green_text_color_hover", "", "Hover Color", "This is some description");
		$row1->addChild("button_green_text_color_hover", $button_green_text_color_hover);
		$row2 = new QodeRow(true);
		$group_green->addChild("row2", $row2);
		$button_green_background_color = new QodeField("colorsimple", "button_green_background_color", "", "Background Color", "This is some description");
		$row2->addChild("button_green_background_color", $button_green_background_color);
		$button_green_background_color_hover = new QodeField("colorsimple", "button_green_background_color_hover", "", "Hover Background Color", "This is some description");
		$row2->addChild("button_green_background_color_hover", $button_green_background_color_hover);
		$button_green_border_color = new QodeField("colorsimple", "button_green_border_color", "", "Border Color", "This is some description");
		$row2->addChild("button_green_border_color", $button_green_border_color);
		$button_green_border_color_hover = new QodeField("colorsimple", "button_green_border_color_hover", "", "Border Hover Color", "This is some description");
        ...
        $counters_text_lineheight = new QodeField("textsimple", "counters_text_lineheight", "", "Text Line Height (px)", "This is some description");
		...
		$group_btt_icon = new QodeGroup("Icon", "Choose Icon for Back To Top");
		$panel14->addChild("group_btt_icon", $group_btt_icon);

        $row_btt_icon = new QodeRow();
		$group_btt_icon->addChild("row_btt_icon", $row_btt_icon);

        QodeIconCollections::getInstance()->getIconsMetaBoxOrOption(
			array(
				'label'				=> esc_html__( 'Icon ', 'qode' ),
				'parent'			=> $row_btt_icon,
				'scope'				=> 'back-to-top',
				'name'				=> 'qode_back_to_top_icon_pack',
				'default_icon_pack'	=> 'font_awesome',
				'default_icon'		=> 'fa fa-arrow-up',
				'type'				=> 'option',
				'field_type'       => 'simple'
			)
		);
        ...
        $slider_circle_navigation = new QodeTitle("slider_circle_navigation", "Qode Slider Bullet Navigation");
        ...
        $slider_bullet_navigation = new QodeTitle("slider_bullet_navigation", "Bullet Navigation for Preview Slider, Content Slider, Advanced Image Gallery and Testimonial Carousel");
        $panel15->addChild("slider_bullet_navigation", $slider_bullet_navigation);

        $group22 = new QodeGroup("Navigation Controls", "Define navigation controls style");
        $panel15->addChild("group22", $group22);

        $row1 = new QodeRow();
        $group22->addChild("row1", $row1);

        $button_bullet_navigation_color = new QodeField("colorsimple", "button_bullet_navigation_color", "", "Color", "This is some description");
        $row1->addChild("button_bullet_navigation_color", $button_bullet_navigation_color);

        $button_bullet_navigation_active_color = new QodeField("colorsimple", "button_bullet_navigation_active_color", "", "Active/Hover Color", "This is some description");
        $row1->addChild("button_bullet_navigation_active_color", $button_bullet_navigation_active_color);

        $button_bullet_navigation_size = new QodeField("textsimple", "button_bullet_navigation_size", "", "Size (px)", "This is some description");
        $row1->addChild("button_bullet_navigation_size", $button_bullet_navigation_size);

        $button_bullet_navigation_border_radius = new QodeField("textsimple", "button_bullet_navigation_border_radius", "", "Border Radius (px)", "This is some description");
        $row1->addChild("button_bullet_navigation_border_radius", $button_bullet_navigation_border_radius);

        $row2 = new QodeRow();
        $group22->addChild("row2", $row2);

        $button_bullet_navigation_border_color = new QodeField("colorsimple", "button_bullet_navigation_border_color", "", "Border Color", "This is some description");
        $row2->addChild("button_bullet_navigation_border_color", $button_bullet_navigation_border_color);

        $button_bullet_navigation_active_border_color = new QodeField("colorsimple", "button_bullet_navigation_active_border_color", "", "Active/Hover Border Color", "This is some description");
