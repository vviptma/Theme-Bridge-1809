...
include 'qode-instagram-helper.php';

/**
 * Class QodeInstagramApi
 */
class QodeInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var QodeInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var QodeInstagramHelper
     */
    private $helper;
     ...
     * @return string
     *
     * @see QodeInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see QodeInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see QodeInstagramApi::getAccessToken()
     */
